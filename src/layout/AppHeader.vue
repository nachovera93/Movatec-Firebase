        ...
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
           <li class="nav-item d-none d-lg-block">
                    <a href="" target="_blank" rel="noopener"
                       class="btn btn-neutral mt-3 btn-icon">
                        <img src="https://www.movatec.cl/wp-content/uploads/2021/01/logo.png">
                    </a>
            </li>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.instagram.com/movatec.cl/"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href=""
                       target="_blank" rel="noopener" data-toggle="tooltip" title="Star us on Github">
                        ...
                        <span class="nav-link-inner--text d-lg-none">Contactanos</span>
                    </a>
                </li>
                ...
                <span class="btn-inner--icon">
                  <i class="fa fa-heart mr-2"></i>
                        ...
                        <span class="nav-link-inner--text">Contactar</span>
                    </a>
                </li>
            </ul>
        </base-nav>
